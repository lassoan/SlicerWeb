...
$mirrors = @{
  ...
  'C:\D\SlicerSimVascular' = '/mirror/SlicerSimVascular'; 'C:\D\svMorph' = '/mirror/svMorph';
  'C:\D\SlicerIGSIO' = '/mirror/SlicerIGSIO'; 'C:\D\SlicerIGT' = '/mirror/SlicerIGT'; 'C:\D\SlicerRT' = '/mirror/SlicerRT'
}
