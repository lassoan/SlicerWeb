...
class SlicerWebApplication:
    ...
    def startup(self):
        ...
        from . import bridge, panels, panels_cli, panels_dvh, panels_markupstomodel, panels_more, panels_segmentations, panels_views, sample_data, segment_editor, session, terminology, views_data  # noqa: F401  (register module GUI bridge methods)
