...
class SlicerWebApplication:
    ...
    def startup(self):
        ...
        from . import bridge, panels, panels_cli, panels_markupstomodel, panels_more, sample_data, segment_editor, terminology, views_data  # noqa: F401  (register module GUI bridge methods)
