...
fetch IGSIO          "$IGSIO_URL"          "$IGSIO_REV"
fetch SlicerIGSIO    "$SLICERIGSIO_URL"    "$SLICERIGSIO_REV"    "$SLICERIGSIO_LOCAL"
fetch SlicerIGT      "$SLICERIGT_URL"      "$SLICERIGT_REV"      "$SLICERIGT_LOCAL"
fetch SlicerRT       "$SLICERRT_URL"       "$SLICERRT_REV"       "$SLICERRT_LOCAL"
...
fetch svMorph          "$SVMORPH_URL"          "$SVMORPH_REV"          "$SVMORPH_LOCAL"
